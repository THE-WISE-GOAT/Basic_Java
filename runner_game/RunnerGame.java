...
public class RunnerGame extends JPanel implements ActionListener {
    ...
    private static final int HUD_Y_OFFSET = 26;
    private static final int HUD_Y_STEP = 21;
    ...
    private static final int DOUBLE_JUMP_THRESHOLD = 11;
    private static final double SPEED_INCREMENT = 0.006;
